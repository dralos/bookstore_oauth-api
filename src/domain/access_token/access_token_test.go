...
func TestGetNewAccessToken(t *testing.T) {
	...
	assert.True(t, at.UserId == 0, "new access token should not have an asssociated user id")
...
func TestAccessTokenIsExpired(t *testing.T) {
	...
	assert.True(t, at.IsExpired(), "empty access toekn should be expired by default")
